...
namespace ApiGateway.IntegrationTests.Controllers.GlobalConfigurations
{
    public class Delete : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        ...
        public async Task GivenId_ReturnsSuccessStatusCode()
        {
            ...
            var response =
                await _client.DeleteAsync(UriForTests.DeleteUri(ControllerNames.GlobalConfigurations, validId));
        ...
        public async Task GivenInvalidId_ReturnsNotFoundStatusCode()
        {
            ...
            var response =
                await _client.DeleteAsync(UriForTests.DeleteUri(ControllerNames.GlobalConfigurations, invalidId));
