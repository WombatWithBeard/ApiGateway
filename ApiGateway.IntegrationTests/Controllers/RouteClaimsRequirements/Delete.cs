...
namespace ApiGateway.IntegrationTests.Controllers.RouteClaimsRequirements
{
    public class Delete : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        ...
        public async Task GivenId_ReturnsSuccessStatusCode()
        {
            ...
            var response =
                await _client.DeleteAsync(UriForTests.DeleteUri(ControllerNames.RouteClaimsRequirements, validId));
        ...
        public async Task GivenInvalidId_ReturnsNotFoundStatusCode()
        {
            ...
            var response =
                await _client.DeleteAsync(UriForTests.DeleteUri(ControllerNames.RouteClaimsRequirements, invalidId));
